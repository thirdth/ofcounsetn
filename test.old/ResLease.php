...
<?php
	...
	if ($_Post) {
			...
			$query ="INSERT INTO rlease (`LLName`, `LLContactAddy`, `LLContactCity`, `LLContactState`, `LLContactZip`, `LLContactEmail`, `LLContactMethod`, `LLNameTwo`, `LLNameThree`, `LLNameFour`, 'LLNameFive`, `TName`, `TAge`, `TSSN`, `TName2`, `TAge2`, TSSN2`)";
...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="ResLease.css">
				  ...
				  <div class="card-block">
					...
					<div id="secondLandlord">
						<div class="form-group row">
							...
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Landlord Name" id="LLNameTwo">
							</div>
						</div>
					...
					<div id="thirdLandlord">
						<div class="form-group row">
							...
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Landlord Name" id="LLNameThree">
							</div>
						</div>
					...
					<div id="fourthLandlord">
						<div class="form-group row">
							...
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Landlord Name" id="LLNameFour">
							</div>
						</div>
					...
					<div id="fifthLandlord">
						<div class="form-group row">
							...
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Landlord Name" id="LLNameFive">
							</div>
						</div>
					</div>
				  </div>
			  ...
			  <div class="card">
				...
				<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
				  <div class="card-block">
					<div id="firstTenant">
						<div class="form-group row">
							<label for="example-text-input" class="sr-only">Tenant Name:</label>
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Tenant Name" id="example-text-input">
							</div>
						</div>

						<form class="form-inline form-group">
							 <div class="form-group">
								<label for="exampleInputName2" class="sr-only">Age</label>
								<input type="text" class="form-control" id="exampleInputName2" placeholder="Tenant Age">
							</div>
							<div class="form-group">
								<label for="LLContactState" class="sr-only">SSN</label>
								<input type="email" class="form-control" id="LLContactState" placeholder="Tenant SSN">
							</div>
						</form>
					...
					<div id="allDependents">
						<div id="firstDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" name="depNameOne">
								</div>
							</div>
						...
						<div id="secondDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameTwo">
								</div>
							</div>
						...
						<div id="thirdDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameThree">
								</div>
							</div>
						...
						<div id="fourthDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameFour">
								</div>
							</div>
						...
						<div id="fifthDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameFive">
								</div>
							</div>
						...
						<div id="sixthDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameSix">
								</div>
							</div>
						...
						<div id="eighthDependent">
							<div class="form-group row">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" value="Dependent Name" id="depNameEight">
								</div>
							</div>
				...
				<div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="card-block">
						<div class="form-group row">
							...
							<div class="col-xs-10">
								<input class="form-control" type="text" value="Leased Premesis Address" name="leaseAddy">
							</div>
						</div>
						<form class="form-inline form-group">
							 <div class="form-group">
					...
					<div class="card-block">
						<div class="form-group row">
							<div class="col-xs-12 form-inline">
									...
									<input class="form-control" id="rentAmount" name="rentAmount" placeholder="Amount: $00.00" type="text"/>
									<label for="date" class="sr-only">
										Location:
									</label>
									<input class="form-control" id="rentAmount" name="rentAmount" placeholder="Location/Bank Name" type="text"/>
									<label class="form-check-label" id="emailNotices">
										<input type="checkbox" class="form-check-input">
						...
						<div id="allowPets">
							...
							<div class="form-inline form-group" id="petInfoOne">
								 <div class="form-group">
									<label for="leaseCity" class="sr-only">Pet Type</label>
									<input type="text" class="form-control" id="leaseCity" placeholder="Pet Type">
								</div>
								<div class="form-group">
									<label for="leaseState" class="sr-only">Pet Description</label>
									<input type="email" class="form-control" id="leaseState" placeholder="Pet Description">
								</div>
								<div class="form-group">
